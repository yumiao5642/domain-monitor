# Generated by Django 3.2.25 on 2025-04-25 10:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_time', models.DateField(blank=True, null=True, verbose_name='任务结束时间')),
                ('monitor_type', models.CharField(choices=[('http', 'HTTP'), ('https', 'HTTPS')], default='https', max_length=10, verbose_name='监控类型')),
                ('request_method', models.CharField(choices=[('GET', 'GET'), ('POST', 'POST')], default='GET', max_length=10, verbose_name='请求方式')),
